...
func emitEmptyPackage(tw *writer.Writer, pkg *packageResult, skipEmpty bool) {
	if skipEmpty {
...
func emitPackage(tapWriter *writer.Writer, pkg *packageResult, verbose bool) {
...
func emitTest(tapWriter *writer.Writer, pkg *packageResult, testRezult *testResult, verbose bool) {
